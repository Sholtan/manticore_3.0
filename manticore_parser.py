...
def parser(string_with_objects_to_process, start_time):
    ...
    if ((not all_data) and (not list_of_bsm) and (not list_of_files) and (not list_of_tails) and (not list_of_days)):
...
def parse_one_BSM(BSM_relative_path):
    ...
    print("Start parse BSM: " + BSM_relative_path)
    with open(".files_list.txt", "a") as files_list:
        BSM_abs_path = "{}{}/".format(
            tools.data_dir(),
            BSM_relative_path)
    ...
    print("End parse BSM: " + BSM_relative_path)
# =============================================================================
#
# =============================================================================
def parse_one_file(relative_file_path):

    print("Start pare one file: " + relative_file_path)
    with open(".files_list.txt", "a") as files_list:
    ...
    print("End pare one file: " + relative_file_path)
# =============================================================================
#
# =============================================================================
def parse_one_tail(tail_relative_path):

    print("Start parse one tail: " + tail_relative_path)
    with open(".files_list.txt", "a") as files_list:
